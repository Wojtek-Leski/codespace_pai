...
<body>
    ...
    <header class="slide-in-left">
        <h1 class="tracking-in-expand">Średnio Zaawansowany Quiz Wiedzy - JAVA SCRIPT</h1>
    </header>
        <br><br><br><br>
    ...
    <aside id="aside_trickshistory" class="slide-in-left">
            <br><br><br>
            <div id="pytania">
            <form action="srednio_zaawansowany_js.php" method="POST">
                <h3>1. What is the correct way to write a JavaScript array?</h3>

                <input type="radio" name="1" value="1" id=""> var colors = ["red", "green", "blue"] <br>
                <input type="radio" name="1" value="2" id=""> var colors = (1:"red", 2:"green", 3:"blue") <br>
                <input type="radio" name="1" value="3" id=""> var colors = 1 = ("red"), 2 = ("green"), 3 = ("blue") <br>

                <h3>2. How do you round the number 7.25, to the nearest integer?</h3>

                <input type="radio" name="2" value="1" id=""> round(7.25) <br>
                <input type="radio" name="2" value="2" id=""> Math.round(7.25) <br>
                <input type="radio" name="2" value="3" id=""> Math.rnd(7.25) <br>

                <h3>3. How does a FOR loop start?</h3>

                <input type="radio" name="3" value="1" id=""> for (i = 0; i <= 5; i++) <br>
                <input type="radio" name="3" value="2" id=""> for (i <= 5; i++) <br>
                <input type="radio" name="3" value="3" id=""> for (i = 0; i <= 5) <br><br>
        ...
        <div id="wyniki">
            ...
            <h3>Poprawne odpowiedzi: <?php if(@$_POST['quiz_button'] == true) echo "1, 2, 1" ?></h3>
