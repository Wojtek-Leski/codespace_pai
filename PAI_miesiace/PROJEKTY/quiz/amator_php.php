...
<body>
    ...
    <header class="slide-in-left">
        <h1 class="tracking-in-expand">Amatorski Quiz Wiedzy - PHP</h1>
    </header>
        <br><br><br><br>
    ...
    <aside id="aside_trickshistory" class="slide-in-left">
            <br><br><br>
            <div id="pytania">
            <form action="amator_php.php" method="POST">
                <h3>1. How do you write "Hello World" in PHP</h3>

                <input type="radio" name="1" value="1" id=""> Document.Write("Hello World"); <br>
                <input type="radio" name="1" value="2" id=""> echo "Hello World";   <br>
                <input type="radio" name="1" value="3" id=""> "Hello World"; <br>

                <h3>2. All variables in PHP start with which symbol?</h3>

                <input type="radio" name="2" value="1" id=""> $ <br>
                <input type="radio" name="2" value="2" id=""> # <br>
                <input type="radio" name="2" value="3" id=""> & <br>

                <h3>3. How do you get information from a form that is submitted using the "get" method?</h3>

                <input type="radio" name="3" value="1" id=""> $_POST[]; <br>
                <input type="radio" name="3" value="2" id=""> $_GET[]; <br>
                <input type="radio" name="3" value="3" id=""> $_GIVE[]; <br><br>
        ...
        <div id="wyniki">
            ...
            <h3>Poprawne odpowiedzi: <?php if(@$_POST['quiz_button'] == true) echo "2, 1, 2" ?></h3>
