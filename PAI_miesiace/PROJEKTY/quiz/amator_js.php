...
<body>
    ...
    <header class="slide-in-left">
        <h1 class="tracking-in-expand">Amatorski Quiz Wiedzy - JAVA SCRIPT</h1>
    </header>
        <br><br><br><br>
    ...
    <aside id="aside_trickshistory" class="slide-in-left">
            <br><br><br>
            <div id="pytania">
            <form action="amator_js.php" method="POST">
                <h3>1. How do you write "Hello World" in an alert box?</h3>

                <input type="radio" name="1" value="1" id=""> alert("Hello World"); <br>
                <input type="radio" name="1" value="2" id=""> alertBox("Hello World"); <br>
                <input type="radio" name="1" value="3" id=""> msgBox("Hello World"); <br>

                <h3>2. How do you create a function in JavaScript?</h3>

                <input type="radio" name="2" value="1" id=""> function myFunction() <br>
                <input type="radio" name="2" value="2" id=""> function is myFunction() <br>
                <input type="radio" name="2" value="3" id=""> function = myFunction() <br>

                <h3>3. Which event occurs when the user clicks on an HTML element?</h3>

                <input type="radio" name="3" value="1" id=""> onmouseover <br>
                <input type="radio" name="3" value="2" id=""> onchange<br>
                <input type="radio" name="3" value="3" id=""> onclick <br><br>
        ...
        <div id="wyniki">
            ...
            <h3>Poprawne odpowiedzi: <?php if(@$_POST['quiz_button'] == true) echo "1, 1, 3" ?></h3>
