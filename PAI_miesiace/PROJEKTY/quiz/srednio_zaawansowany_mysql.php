...
<body>
    ...
    <header class="slide-in-left">
        <h1 class="tracking-in-expand">Średnio Zaawansowany Quiz Wiedzy - MYSQL</h1>
    </header>
        <br><br><br><br>
    ...
    <aside id="aside_trickshistory" class="slide-in-left">
            <br><br><br>
            <div id="pytania">
            <form action="srednio_zaawansowany_mysql.php" method="POST">
                <h3>1. Which MySQL statement is used to create a database table called 'Customers'?</h3>

                <input type="radio" name="1" value="1" id=""> CREATE DATABASE TAB Customers <br>
                <input type="radio" name="1" value="2" id=""> CREATE TABLE Customers <br>
                <input type="radio" name="1" value="3" id=""> CREATE DATABASE TABLE Customers <br>

                <h3>2. Which operator is used to search for a specified pattern in a column?</h3>

                <input type="radio" name="2" value="1" id=""> LIKE <br>
                <input type="radio" name="2" value="2" id=""> GET <br>
                <input type="radio" name="2" value="3" id=""> FROM <br>

                <h3>3. With MySQL, how can you return the number of records in the "Persons" table?</h3>

                <input type="radio" name="3" value="1" id=""> SELECT LEN(*) FROM Persons <br>
                <input type="radio" name="3" value="2" id=""> SELECT COLUMNS(*) FROM Persons <br>
                <input type="radio" name="3" value="3" id=""> SELECT COUNT(*) FROM Persons <br><br>
        ...
        <div id="wyniki">
            ...
            <h3>Poprawne odpowiedzi: <?php if(@$_POST['quiz_button'] == true) echo "2, 1, 3" ?></h3>
