...
<body>
    ...
    <header class="slide-in-left">
        <h1 class="tracking-in-expand">Zaawansowany Quiz Wiedzy - PHP</h1>
    </header>
        <br><br><br><br>
    ...
    <aside id="aside_trickshistory" class="slide-in-left">
            <br><br><br>
            <div id="pytania">
            <form action="zaawansowany_php.php" method="POST">
                <h3>1. The PHP syntax is most similar to:</h3>

                <input type="radio" name="1" value="1" id=""> VBScript <br>
                <input type="radio" name="1" value="2" id=""> Perl and C <br>
                <input type="radio" name="1" value="3" id=""> JavaScript <br>

                <h3>2. What does PHP stand for?</h3>

                <input type="radio" name="2" value="1" id=""> PHP: Hypertext Preprocessor  <br>
                <input type="radio" name="2" value="2" id=""> Personal Hypertext Processor <br>
                <input type="radio" name="2" value="3" id=""> Private Home Page <br>

                <h3>3. What is the correct way to open the file "time.txt" as readable?</h3>

                <input type="radio" name="3" value="1" id=""> fopen("time.txt","read"); <br>
                <input type="radio" name="3" value="2" id=""> open("time.txt"); <br>
                <input type="radio" name="3" value="3" id=""> fopen("time.txt","r");   <br><br>
