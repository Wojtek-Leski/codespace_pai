...
<body>
    ...
    <header class="slide-in-left">
        <h1 class="tracking-in-expand">Zaawansowany Quiz Wiedzy - MYSQL</h1>
    </header>
        <br><br><br><br>
    ...
    <aside id="aside_trickshistory" class="slide-in-left">
            <br><br><br>
            <div id="pytania">
            <form action="zaawansowany_mysql.php" method="POST">
                <h3>1. How can you change "Hansen" into "Nilsen" in the "LastName" column in the Persons table?</h3>

                <input type="radio" name="1" value="1" id=""> UPDATE Persons SET LastName='Hansen' INTO LastName='Nilsen' <br>
                <input type="radio" name="1" value="2" id=""> UPDATE Persons SET LastName='Nilsen' WHERE LastName='Hansen'  <br>
                <input type="radio" name="1" value="3" id=""> MODIFY Persons SET LastName='Nilsen' WHERE LastName='Hansen' <br>

                <h3>2. With MySQL, how can you insert "Olsen" as the "LastName" in the "Persons" table?</h3>

                <input type="radio" name="2" value="1" id=""> INSERT ('Olsen') INTO Persons (LastName) <br>
                <input type="radio" name="2" value="2" id=""> INSERT INTO Persons (LastName) VALUES ('Olsen')   <br>
                <input type="radio" name="2" value="3" id=""> INSERT INTO Persons ('Olsen') INTO LastName <br>

                <h3>3. What are the supported types of joins in MySQL?</h3>

                <input type="radio" name="3" value="1" id=""> INNER JOIN, LEFT JOIN, RIGHT JOIN, CROSS JOIN   <br>
                <input type="radio" name="3" value="2" id=""> INNER JOIN, OUTER JOIN, RIGHT JOIN, BETTER JOIN   <br>
                <input type="radio" name="3" value="3" id=""> INNER JOIN, LEFT JOIN, VALUE JOIN, CROSS JOIN   <br><br>
        ...
        <div id="wyniki">
            ...
            <h3>Poprawne odpowiedzi: <?php if(@$_POST['quiz_button'] == true) echo "2, 2, 1" ?></h3>
