...
<body>
    ...
    <header class="slide-in-left">
        <h1 class="tracking-in-expand">Amatorski Quiz Wiedzy - MYSQL</h1>
    </header>
        <br><br><br><br>
    ...
    <aside id="aside_trickshistory" class="slide-in-left">
            <br><br><br>
        <div id="pytania">
            <form action="amator_mysql.php" method="POST">
                <h3>1. Which MySQL statement is used to select data from a database?</h3>

                <input type="radio" name="1" value="1" id=""> EXTRACT <br>
                <input type="radio" name="1" value="2" id=""> GET <br>
                <input type="radio" name="1" value="3" id=""> SELECT <br>

                <h3>2. With MySQL, how do you select all the columns from a table named "Persons"?</h3>

                <input type="radio" name="2" value="1" id=""> EXTRACT FirstName FROM Persons <br>
                <input type="radio" name="2" value="2" id=""> SELECT FirstName FROM Persons <br>
                <input type="radio" name="2" value="3" id=""> SELECT Persons.FirstName <br>

                <h3>3. Which MYSQL statement is used to insert new data in a database?</h3>

                <input type="radio" name="3" value="1" id=""> INSERT INTO <br>
                <input type="radio" name="3" value="2" id=""> INSERT NEW <br>
                <input type="radio" name="3" value="3" id=""> ADD NEW <br><br>
        ...
        <div id="wyniki">
            ...
            <h3>Poprawne odpowiedzi: <?php if(@$_POST['quiz_button'] == true) echo "3, 2, 1" ?></h3>
